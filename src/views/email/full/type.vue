  ...
  <div class="app-container">
    ...
    <el-form ref="dynamicValidateForm" :model="dynamicValidateForm" :rules="ruleValidate" label-width="80px" label-position="left">
      ...
      <el-form-item label="邮件模板">
        <el-select v-model="dynamicValidateForm.tem" placeholder="请选择">
          <el-option
      ...
      <el-form-item>
        <el-button type="primary" :disabled="!isManage" :loading="commmitLoading" @click="submitForm('dynamicValidateForm')">提交审批</el-button>
...
import { getProduct, sendEmail, emailDetai, getUids, saveMailTemplate } from '@/api/email'
